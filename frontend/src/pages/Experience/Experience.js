    ...
    <div className="container">
      <div className="experience" id="experience">
        ...
        <div className="entry">
          ...
          <ul>
            <li>
              Developed a cutting-edge customer portal for purchasing CNC
              machine replacement parts using the MERN stack.
            </li>
            <li>
            ...
            <li>
              Conducted thorough testing and troubleshooting of interface
              software to identify and resolve any functionality or
              compatibility issues, ensuring optimal performance across
              platforms.
            </li>
          </ul>
        </div>
        <div className="entry">
          ...
          <ul>
            ...
            <li>
              Built over one hundred PCs for a wave of new hires joining the
              firm.
            </li>
            <li>
              Built a new website and SQL database to manage gathering new hire
              information by HR and status of PC builds using HTML, CSS, SQL,
              and PHP.
            </li>
            <li>
        ...
        <div className="entry">
          ...
          <ul>
            ...
            <li>
              Shipped over one hundred pieces of required equipment for
              employees across the country.
            </li>
            <li>
              Worked with a team to set up the required equipment for the
